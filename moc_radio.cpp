...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Radio_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 21, 5)
    ...
    "Radio\0bufferChanged\0\0value\0"
};
...
void Radio::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->bufferChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Radio::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Radio::bufferChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Radio::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Radio.data,
      qt_meta_data_Radio,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Radio.stringdata))
...
// SIGNAL 0
void Radio::bufferChanged(int _t1)
{
